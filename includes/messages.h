...
/*   Updated: 2025/02/19 13:00:10 by guphilip         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define MSG_ERROR_EXTENSION RED "Error:\n Map file must have .ber extension\n" RESET
# define MSG_ERROR_RECTANGLE RED "Error:\n Map must be rectangular\n" RESET
# define MSG_ERROR_WALLS RED "Error:\n Map must be fully surronded by walls\n" RESET
# define MSG_ERROR_INVALID RED "Error:\n Map contain invalid elements\n" RESET
# define MSG_ERROR_MISSING RED "Error:\n Map must have 1 player, at least 1 collectible and 1 exit\n" RESET
# define MSG_ERROR_UNSOLVABLE RED "Error:\n The map is unsolvable. Check the path to the exit and collectibles" RESET
# define MSG_MAP_SUCCESS GREEN "Success :\n Map is valid and playable\n" RESET
# define MAP_UNREADABLE RED "Map cannot be read\n" RESET
# define MSG_ERROR_COPY RED "Map cannot be copied\n" RESET
# define MSG_USAGE RED "Error :\n" GREEN "Usage :" RESET "./so_long <map/map.ber>\n" RESET
