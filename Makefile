...
#    Updated: 2025/02/18 19:18:46 by guphilip         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES 			=		so_long test utils/map/clean utils/map/read_map utils/map/copy_map utils/map/check_map utils/map/flood_fill utils/hooks/hooks utils/map/draw_map utils/player/move_player utils/print/print_score utils/print/print_titles utils/print/print_col utils/print/print_name utils/enemy/spawn_enemy utils/enemy/move_enemies utils/player/load_player_sprites errors/errors errors/manage_errors
